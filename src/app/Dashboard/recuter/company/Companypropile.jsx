...
export default function CompanyProfile({ companys, recuiterdata }) {
    ...
    const handleSubmit = async (e) => {
        ...
        // Fixed function name and added error handling
        try {
            const payload = await creatcompnay(newCompanyData);
            ...
            setErrors(prev => ({ ...prev, submit: "Failed to create company profile" }));
        }
